...
print(f'Hello, {guests[2].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[3].title()}! Come to dinner with me! :)')
...
guests.insert(2, 'gerard way')
guests.append('chino moreno')
print(f'Hello, {guests[0].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[1].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[2].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[3].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[4].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[5].title()}! Come to dinner with me! :)')
print(f'Hello, {guests[6].title()}! Come to dinner with me! :)')
