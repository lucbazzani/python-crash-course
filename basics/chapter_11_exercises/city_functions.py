...
# IT IS COMMENTED BECAUSE THE FUNCTION WAS UPDATED IN THE NEXT EXERCISE
# def get_formatted_location(city, country):
#     """Return a string representing a city and country."""
...
def get_formatted_location(city, country, population=None):
    """Return a string representing a city and country and its population."""
